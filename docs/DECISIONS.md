...
## DEC-024 — Phát triển cho tự học hằng ngày và thương mại hóa theo cổng

- Ngày 2026-09-11, người dùng yêu cầu một file task phát triển chuyên nghiệp từ khách hàng đến sản phẩm cuối, phục vụ bản thân trong đời sống/luyện hằng ngày và hướng thương mại. Phạm vi lượt này là xây kế hoạch có thể thực thi và đồng bộ tài liệu, không coi đã triển khai các tính năng được đề xuất.
- Chọn [TASKS_COMMERCIAL.md](TASKS_COMMERCIAL.md) làm nơi duy nhất quản lý ID COM; TASKS giữ task cũ và dẫn sang file mới. Bản nháp ROADMAP_COMMERCIAL có sẵn trong working tree giữ nguyên, không dùng các mốc DONE/giá/lịch quý chưa kiểm chứng làm trạng thái chính thức.
- Ưu tiên: dùng cá nhân tin cậy → beta nền tảng → AI/IELTS được kiểm định khi công bố → bán thử giới hạn → mở rộng theo dữ liệu. Beta nền tảng G2 không yêu cầu AI, nhưng không đóng BETA-001 cũ vốn gồm AI nói/viết. Gói bán AI/IELTS bắt buộc qua G3; có thể bán gói nền tảng mô tả trung thực sau các điều kiện thương mại riêng.
- Giả định để lập phần độc lập: nghiên cứu B2C người Việt trưởng thành trước; đây không phải xác nhận thị trường, mức trả tiền hay giới hạn khách hàng vĩnh viễn. Đầu vào/loại thi/ngày thi, nhân sự thật, giáo viên, ngân sách, giá, provider và ngày mở bán còn cần bằng chứng ở task tương ứng.
- Giữ React/TypeScript/Vite PWA + Vercel/Render/Neon Managed Auth REST. Không tự chuyển stack, dựng microservice/CMS/native/B2B hoặc mở chi phí. Quản trị, QA, support và tài chính có vai trò đầy đủ nhưng có thể kiêm nhiệm; không giả có reviewer/giáo viên độc lập.
- Các số mẫu beta, nhật ký 14 ngày, sprint và SLO/RPO/RTO trong kế hoạch là đề xuất để chốt trước thử nghiệm, không là kết quả hoặc cam kết kinh doanh. DONE task có phạm vi khác với phát hành production; thiếu cloud/thiết bị/giáo viên được ghi rõ thay vì suy từ test local.
- COM-GOV-001 READY là task kế hoạch tiếp theo; DEPLOY-002 tiếp tục IN_PROGRESS qua COM-OPS-001. Giữ thay đổi có sẵn IDE, package/lockfile, CI/Sentry và tài liệu; không commit/push/deploy trong lượt lập kế hoạch.

## DEC-025 — Bắt đầu charter/kiểm kê và cập nhật cloud theo bằng chứng mới

- Ngày 2026-09-11, người dùng yêu cầu bắt đầu backlog. COM-GOV-001 tạo PRODUCT_CHARTER v1, COM-GOV-002 kiểm kê code và chạy baseline; giữ phạm vi PWA/Neon, dùng cá nhân tin cậy trước thương mại.
- Người dùng trả lời “ok” cho câu hỏi trình độ/lịch/thiết bị và muốn đầu tư nhiều cho chất lượng nhưng không nêu hạn mức tiền. Không suy ra mức đầu vào, lịch, thiết bị hoặc ngân sách vô hạn. Charter ghi các mục chưa xác định, giữ chi phát sinh mới/AI off/0; COM-BIZ-001 xây kịch bản khi có nguồn giá/phạm vi phù hợp.
- GET công khai mới đạt frontend, health/readiness, Auth không phiên và API từ chối thiếu token. Thay bước vận hành cũ “áp migration” bằng kiểm tra revision/grants và OTP/sync; không tự áp SQL, đổi secret hoặc đánh dấu DEPLOY-002 DONE. Readiness không chứng minh đã bỏ mọi quyền quản trị hay reset credential.
- COM-GOV-001/002 DONE là đầu ra charter/kiểm kê, không phải nghiệm thu G0/G1 hoặc xác nhận reviewer độc lập. Giữ 7 khoảng trống trong BASELINE_AUDIT làm đầu vào task có sẵn; COM-OPS-002 READY sửa CI/CD, COM-OPS-001 IN_PROGRESS cloud.
- Lượt này không thay runtime hoặc triển khai; kiểm tra lại lint/typecheck/unit và artifact release để biết baseline thật. Một timeout mobile không tái hiện ở lượt riêng được ghi trung thực, giữ trace và đưa vào COM-QA-001.

## Các giả định/chọn lựa còn mở (hiện tại)

| Mã       | Vấn đề                                                    | Mặc định hiện tại                                                                                                                                                                                           | Thời điểm cần làm rõ                                                                                                             |
| -------- | --------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| OPEN-001 | Cá nhân hay nhiều học viên | Người dùng đã yêu cầu tự học hằng ngày và thương mại hóa (DEC-024); giả thuyết B2C người trưởng thành, phân khúc chưa kiểm định | COM-GOV-001 và COM-RES-001/002/003 trước beta khách hàng |
...
| OPEN-005 | Project hosting, Neon, tên miền và Auth | 2026-09-11 probe Vercel frontend/healthz/readyz đạt, get-session không cookie null; chưa có revision/grants/OTP/sync đầy đủ | COM-OPS-001: xác minh revision, grants chỉ đọc, xử lý credential cũ rồi OTP/sync; không chạy lại migration từ lỗi lịch sử |
