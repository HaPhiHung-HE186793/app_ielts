...
| OPEN-005 | Project hosting, Neon, tên miền và Auth                   | Neon production/neondb: query cloud thiếu schema_version/api/worker, runtime có neon_superuser; Render UNKNOWN. DB ep-dawn-dream cần đối chiếu Auth ep-long-cell. Chưa có migration thành công/OTP/URL Live | DEPLOY-002: áp migration, chỉnh quyền runtime, kiểm tra version/grants rồi redeploy; nếu vẫn UNKNOWN thì chẩn đoán kết nối riêng |
