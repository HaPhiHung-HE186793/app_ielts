...
| OPEN-005 | Project hosting, Neon, tên miền và Auth                   | Neon production/neondb Singapore; runtime role đã chọn, Render qua validator nhưng DB/schema/quyền chưa đạt. DB endpoint ep-dawn-dream cần đối chiếu với Auth URL ep-long-cell cũ. Chưa xác minh migration/OTP/URL Live | DEPLOY-002: log NEON_DB_* + check_setup, sửa đúng nguyên nhân rồi Vercel/origin/kiểm tra hai tài khoản; secret giữ riêng |
